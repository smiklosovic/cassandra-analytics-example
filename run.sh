...
docker exec -i spark_master_1 sh -c 'cd /submit/analytics-app; ${SPARK_HOME}/bin/spark-submit \
    ...
    --jars cassandra-analytics-core-0.1.0.jar,cassandra-analytics-common-0.1.0.jar,cassandra-analytics-spark-converter-0.1.0.jar,cassandra-bridge-0.1.0.jar,bridges/four-zero-types.jar,bridges/four-zero-bridge.jar,bridges/four-zero.jar,bridges/four-zero-sparksql.jar,bridges/four-zero-avro.jar,netty-nio-client-2.26.12.jar,s3-2.26.12.jar \
