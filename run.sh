...
docker exec -i spark_master_1 sh -c 'cd /submit/analytics-app; ${SPARK_HOME}/bin/spark-submit \
    ...
    --jars cassandra-analytics-core_spark3_2.12-1.0.0.jar,cassandra-analytics-common_spark3_2.12-1.0.0.jar,cassandra-analytics-spark-converter_spark3_2.12-1.0.0.jar,cassandra-bridge_spark3_2.12-1.0.0.jar,bridges/four-zero-types.jar,bridges/four-zero-bridge.jar,bridges/four-zero.jar,bridges/four-zero-sparksql.jar,bridges/four-zero-avro.jar \
